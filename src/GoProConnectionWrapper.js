...
//         setProjectIdError('');
//         try {
//             const response = await axios.get('https://proxy-server-pink.vercel.app/api/gopro/camera/shutter/start');
//             if (response.status === 200) {
//                 setRecording(true);
...
//         try {
//             const response = await axios.get('https://proxy-server-pink.vercel.app/api/gopro/camera/shutter/stop');
//             if (response.status === 200) {
//                 setRecording(false);
...
//         const stateResponse = await axios.get('https://proxy-server-pink.vercel.app/api/gopro/camera/state');
...
//         const url = `https://proxy-server-pink.vercel.app/api/videos/DCIM/${directory}/${filename}`;
...
//         try {
//             const response = await axios.get('https://proxy-server-pink.vercel.app/api/gopro/media/list');
//             if (response.status === 200) {
